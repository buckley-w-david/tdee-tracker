...
module GeneratedUrlHelpersModule
  ...
  def by_date_entries_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def day_index_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def day_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_day_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_entry_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def entries_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def entry_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def import_entries_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_day_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_entry_url(*args); end
