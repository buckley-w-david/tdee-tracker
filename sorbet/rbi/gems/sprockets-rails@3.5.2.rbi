...
class Rails::Application < ::Rails::Engine
  # source://railties/7.2.0/lib/rails/application.rb#108
  ...
  # source://railties/7.2.0/lib/rails/application.rb#101
  def autoloaders; end

  # source://railties/7.2.0/lib/rails/engine.rb#516
  def build_middleware_stack; end

  # source://railties/7.2.0/lib/rails/application.rb#439
  def config; end

  # source://railties/7.2.0/lib/rails/application.rb#443
  def config=(_arg0); end

  # source://railties/7.2.0/lib/rails/application.rb#276
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/7.2.0/lib/rails/application.rb#359
  def console(&blk); end

  # source://railties/7.2.0/lib/rails/application.rb#480
  def credentials; end

  # source://railties/7.2.0/lib/rails/application.rb#444
  def credentials=(_arg0); end

  # source://railties/7.2.0/lib/rails/application.rb#103
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.2.0/lib/rails/application.rb#103
  def default_url_options=(arg); end

  # source://railties/7.2.0/lib/rails/application.rb#232
  def deprecators; end

  # source://railties/7.2.0/lib/rails/application.rb#538
  def eager_load!; end

  # source://railties/7.2.0/lib/rails/application.rb#499
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/7.2.0/lib/rails/application.rb#305
  def env_config; end

  # source://railties/7.2.0/lib/rails/application.rb#101
  def executor; end

  # source://railties/7.2.0/lib/rails/application.rb#365
  def generators(&blk); end

  # source://railties/7.2.0/lib/rails/application.rb#512
  def helpers_paths; end

  # source://importmap-rails/2.0.1/lib/importmap/engine.rb#4
  def importmap; end

  # source://importmap-rails/2.0.1/lib/importmap/engine.rb#4
  def importmap=(_arg0); end

  # source://railties/7.2.0/lib/rails/application.rb#426
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/7.2.0/lib/rails/application.rb#133
  def initialized?; end

  # source://railties/7.2.0/lib/rails/application.rb#347
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/7.2.0/lib/rails/application.rb#433
  def initializers; end

  # source://railties/7.2.0/lib/rails/application.rb#376
  def isolate_namespace(mod); end

  # source://railties/7.2.0/lib/rails/application.rb#160
  def key_generator(secret_key_base = T.unsafe(nil)); end

  # source://railties/7.2.0/lib/rails/application.rb#532
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/7.2.0/lib/rails/application.rb#224
  def message_verifier(verifier_name); end

  # source://railties/7.2.0/lib/rails/application.rb#196
  def message_verifiers; end

  # source://railties/7.2.0/lib/rails/application.rb#528
  ...
  # source://railties/7.2.0/lib/rails/application.rb#340
  def rake_tasks(&block); end

  # source://railties/7.2.0/lib/rails/application.rb#152
  ...
  # source://railties/7.2.0/lib/rails/application.rb#402
  def require_environment!; end

  # source://railties/7.2.0/lib/rails/application.rb#407
  def routes_reloader; end

  # source://railties/7.2.0/lib/rails/application.rb#137
  def run_load_hooks!; end

  # source://railties/7.2.0/lib/rails/application.rb#353
  def runner(&blk); end

  # source://railties/7.2.0/lib/rails/application.rb#99
  def sandbox; end
  ...
  # source://railties/7.2.0/lib/rails/application.rb#462
  def secret_key_base; end

  # source://railties/7.2.0/lib/rails/application.rb#371
  def server(&blk); end

  # source://railties/7.2.0/lib/rails/application.rb#508
  def to_app; end

  # source://railties/7.2.0/lib/rails/application.rb#414
  def watchable_args; end

  protected

  # source://railties/7.2.0/lib/rails/application.rb#611
  def default_middleware_stack; end

  # source://railties/7.2.0/lib/rails/application.rb#616
  def ensure_generator_templates_added; end

  # source://railties/7.2.0/lib/rails/application.rb#577
  def ordered_railties; end

  # source://railties/7.2.0/lib/rails/application.rb#599
  def railties_initializers(current); end

  # source://railties/7.2.0/lib/rails/application.rb#566
  def run_console_blocks(app); end

  # source://railties/7.2.0/lib/rails/application.rb#556
  def run_generators_blocks(app); end

  # source://railties/7.2.0/lib/rails/application.rb#561
  def run_runner_blocks(app); end

  # source://railties/7.2.0/lib/rails/application.rb#571
  def run_server_blocks(app); end

  # source://railties/7.2.0/lib/rails/application.rb#545
  def run_tasks_blocks(app); end

  private

  # source://railties/7.2.0/lib/rails/application.rb#629
  def build_middleware; end

  # source://railties/7.2.0/lib/rails/application.rb#622
  def build_request(env); end

  # source://railties/7.2.0/lib/rails/application.rb#633
  def coerce_same_site_protection(protection); end

  # source://railties/7.2.0/lib/rails/application.rb#637
  def filter_parameters; end

  class << self
    # source://railties/7.2.0/lib/rails/application.rb#395
    def add_lib_to_load_path!(root); end

    # source://railties/7.2.0/lib/rails/application.rb#83
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/7.2.0/lib/rails/application.rb#87
    def find_root(from); end

    # source://railties/7.2.0/lib/rails/application.rb#70
    def inherited(base); end

    # source://railties/7.2.0/lib/rails/application.rb#79
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/7.2.0/lib/rails/application/configuration.rb#30
  def initialize(*_arg0); end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#14
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#558
  def annotations; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#28
  def api_only; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#373
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#468
  def autoload_lib(ignore:); end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#480
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#385
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#492
  def colorize_logging; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#496
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#563
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#431
  def database_configuration; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#387
  def debug_exception_response_format; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#391
  def debug_exception_response_format=(_arg0); end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#580
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#349
  def enable_reloading; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#353
  def enable_reloading=(value); end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#28
  def encoding; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#365
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#592
  def inspect; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#413
  def load_database_yaml; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#91
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#380
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#393
  def paths; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#572
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#357
  def read_encrypted_secrets; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#361
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#345
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#501
  def secret_key_base; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#511
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#538
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#554
  ...
  # source://railties/7.2.0/lib/rails/application/configuration.rb#619
  def credentials_defaults; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#629
  def generate_local_secret; end

  # source://railties/7.2.0/lib/rails/application/configuration.rb#641
  def generate_local_secret?; end
end
